...
-   Click **"Browse or Select..."** under the **Survey Folder** section.
-   Navigate to the folder containing your survey files (refer to the [Select Directory](#sec-select-directory)).
